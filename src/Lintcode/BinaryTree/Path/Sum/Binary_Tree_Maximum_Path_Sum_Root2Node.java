 ...
 *
 */
public class Binary_Tree_Maximum_Path_Sum_Root2Node {
...
//		String TreeNodeStrIn ="{1,9,8}";
		...
		TreeNode<Integer> root = TreeNodeUtils.fromStringToTree(TreeNodeStrIn, TreeNode.class, Integer.class); //.fromStringToTree(TreeNodeStrIn);
