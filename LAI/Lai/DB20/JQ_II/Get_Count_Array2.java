...
public class Get_Count_Array2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
//		int[] arr = {5,1,3,2};
		int[] arr = {5,2,6,1};//right: 2110, left: 0,0,2,0, all: 2,1,3,0 why 1100 右边比大的有几个？
...
//		ArrayUtils.printIntArray("helper",helper);
		...
		merge(arr, indexArr, countArr, prevIndexArr, start, mid, end);
