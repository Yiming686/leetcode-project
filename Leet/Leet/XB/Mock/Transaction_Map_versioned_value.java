...
public class Transaction_Map_versioned_value {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
//		KVStore kvStore = new KVStore();
		Transaction_Map_versioned_value kv = new Transaction_Map_versioned_value();
	...
	Map<String, VersionedValue> keyVersionedValueMap = new HashMap<>();;
	
	Transaction_Map_versioned_value(){
		map = new HashMap<>();
